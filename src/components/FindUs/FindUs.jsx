...
const FindUs = () => (
    <div id='contact' className='min-h-[100vh] capitalize m-0 lg:mx-20 flex flex-col lg:flex-row items-center justify-center'>
    <div className='p-5 lg:w-[65%] '>
      <SubHeadings title='Contact '/>
      <h1 className='mt-10 mb-7 tracking-wider uppercase text-6xl lg:text-[100px]  font-serif font-thin text-orange-300'>find us</h1>
