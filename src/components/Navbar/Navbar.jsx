...
const Navbar = () =>{
  ...
  return (
    <nav className='sticky top-0 flex flex-row lg:gap-5 justify-between items-center bg-black text-white lg:px-5 lg:py-1 select-none'>
...
{/* ----------Small Screen----------- */}
      <div className='flex flex-col lg:hidden  '>
        <div className='flex text-2xl justify-end p-5 '>
          <GiHamburgerMenu onClick={()=> setToggleMenu(true)} className="hover:text-yellow-200 cursor-pointer"/>
        </div>
       {
        toggleMenu &&
        <div className='w-[100vw] h-[100vh] absolute left-0 top-0 z-10 backdrop-blur-2xl  transition-all ease-in duration-200 text-black font-extralight font-serif'>
          <div className='flex text-4xl justify-end p-5 text-yellow-100'>
          ...
          <div className='flex flex-col items-center capitalize' onClick={()=> setToggleMenu(false)}>
            <div className='p-3 hover:text-orange-500 transition-colors'><a href="#home">Home </a></div>
            <div className='p-3 hover:text-orange-500 transition-colors'><a href="#about">about </a></div>
            <div className='p-3 hover:text-orange-500 transition-colors'><a href="#menu">menu </a></div>
            <div className='p-3 hover:text-orange-500 transition-colors'><a href="#awards">awards </a></div>
            <div className='p-3 hover:text-orange-500 transition-colors'><a href="#contact">contact </a></div>
            <div className='p-3 hover:text-orange-500 transition-colors'><a href="/">Log in / register </a></div>
            <div className='p-3 hover:text-orange-500 transition-colors'><a href="/">book table </a></div>
          </div>
        </div>
        }
      </div>
