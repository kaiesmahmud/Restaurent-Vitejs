  ...
  return (
    <nav className='z-10 sticky top-0 flex flex-row lg:gap-5 justify-between items-center backdrop-blur-3xl text-white lg:px-5 lg:py-1 select-none'>
      <div className='w-[100px] flex justify-start items-center'>
        <p className='text-4xl p-5  font-extralight select-none cursor-pointer'>Res<span className='text-teal-300'>2</span>rentz</p>
      </div>
...
{/* ----------Small Screen----------- */}
      <div className='flex flex-col lg:hidden'>
       ...
       {
        toggleMenu &&
        <div className='w-[100%] h-[100vh] absolute left-0 top-0 z-20 bg-black  transition-all ease-in duration-200 font-extralight font-serif'>
